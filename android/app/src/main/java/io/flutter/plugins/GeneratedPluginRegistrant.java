...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new cn.vvkeep.power_file_view.PowerFileViewPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin power_file_view, cn.vvkeep.power_file_view.PowerFileViewPlugin", e);
    }
    try {
